...
pub(crate) use self::{
    ...
    sidebar::{
        agent_panel_body_rect, agent_panel_entries, agent_panel_row_gap,
        agent_panel_row_height_in_body, agent_panel_rows, agent_panel_scroll_for_target,
        ...
        workspace_parent_group_state, AgentPanelEntry, AgentPanelRow, AgentPanelTarget,
        WorkspaceListEntry,
    },
};
